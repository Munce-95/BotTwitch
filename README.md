...
1. **Python** : Installe Python 3.8 ou plus.
2. **Dépendances** :
   Ouvre un terminal et tape :
   pip install spotipy
3. **Identifiants** : Configure tes accès Spotify et Twitch dans le fichier 'main.py'.
4. **Données** : Assure-toi que le dossier '.data/' contient bien le fichier 'ad_bot_suspicion.txt' (ta liste de mots bannis).
...
- **Erreur 400 (Base62 ID)** : L'ID de ta playlist est mal copié dans main.py.
